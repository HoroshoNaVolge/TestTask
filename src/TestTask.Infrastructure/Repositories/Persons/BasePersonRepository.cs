...
public abstract class BasePersonRepository<TEntity> : IPersonRepository<TEntity> where TEntity : class, IEntity
{
    ...
    protected BasePersonRepository(ApplicationDbContext context, IMemoryCache cache)
    {
